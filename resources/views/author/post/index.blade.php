...
@section("content")
    ...
    <div class="container-fluid">
        <div class="block-header">
            <a href="{{route('author.post.create')}}" class="btn btn-primary"> <i class="material-icons"> add</i> Add New Post </a>
        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($posts as $keys=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            <a  class="btn btn-info" href="{{route('author.post.edit',$post->id)}}">
                                                <i class="material-icons ">edit</i>
                                            </a>


                                            <a  class="btn btn-info" href="{{route('author.post.show',$post->id)}}">
