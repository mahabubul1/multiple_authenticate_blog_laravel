                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($posts as $keys=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            {{$post->is_approved==true?'Approved':'pending'}}
                                        </td>

                                        <td>
                                            <button class="btn btn-success" type="submit" onclick="postAprroved({{$post->id}})">
                                                <i class="material-icons ">done</i>
                                            </button>
                                            <form  id="approved-form-{{$post->id}}" action="{{route('admin.post.approved',$post->id)}}" method="POST" style="display: none">
                                                @csrf
                                                @method("PUT")
