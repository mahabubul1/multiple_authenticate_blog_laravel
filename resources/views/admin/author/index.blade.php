        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            All Author <strong>{{$authors->count()}}</strong>
                        </h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tr>
                                    ...
                                    <th>post</th>
                                    <th>Comment</th>
                                    <th><i style="color:red" class="material-icons">favorite</i></th>
                                    <th> Created At</th>
                                    <th>Actions</th>
                                ...
                                <tbody>
                                @foreach($authors as $keys=>$author)
                                    <tr>
                                        <td>{{$keys +1}}</td>
                                        <th>{{$author->name}}</th>
                                        <th>{{$author->posts->count()}}</th>
                                        <th>{{$author->comments->count()}}</th>
                                        <th>{{$author->favorite_posts->count()}}</th>
                                        <td>{{$author->created_at}}</td>
                                        <td>
                                            <button class="btn btn-danger" type="submit" onclick="deleteAuthor({{$author->id}} )">
