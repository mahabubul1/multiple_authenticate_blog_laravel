...
@section("content")
        ...
        <div class="container-fluid">
            <div class="block-header">
                <a href="{{route('admin.tag.create')}}" class="btn btn-primary"> <i class="material-icons"> add</i> Add New Tag </a>
            </div>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-danger" type="submit" onclick="deleteTag({{$tag->id}})">
